...
export const mockDebts: Debt[] = [
  ...
  },
  {
    ...
    name: "Amazon Card",
    debt_type: "credit_card",
    current_balance: 3360,
    starting_balance: 3360,
    interest_rate: 0.3299,
    minimum_payment: 76.34,
    due_day: 10,
    created_at: "2025-09-15T00:00:00Z",
    last_verified_at: "2026-02-20T00:00:00Z",
    promo_type: "deferred_interest",
    promo_apr: 0,
    promo_end_date: "2026-09-15",
    promo_balance: 3360,
    regular_apr: 0.3299,
    actual_payment: 150,
  },
  {
    ...
    debt_type: "credit_card",
    current_balance: 639,
    starting_balance: 639,
    interest_rate: 0.2874,
    minimum_payment: 29,
    due_day: 5,
